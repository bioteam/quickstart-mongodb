...
sed -e '/^\s*\/\*/,/\*\/$/d' -e '/^\s*\/\//d' templates/mongodb-node.template > build/templates/mongodb-node.template
...
aws s3 cp build/templates/mongodb-node.template s3://mongo-db-sharded/mongo-db-sharded/templates/
